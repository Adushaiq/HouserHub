            ...
            <div className="bg-wrapper position-relative z-1 pt-85 lg-pt-70 pb-100 xl-pb-80 lg-pb-70">
               <div className="row">
                  <div className="col-xl-7 col-lg-8 col-md-10 m-auto text-center">
                     ...
                     <p className="fs-24 text-white mt-30 mb-45 lg-mb-30">Your trusted partner in residential and commercial real estate.</p>
                     <Link href="/about_us" className="btn-two"><span>Get Started</span></Link>
                  </div>
               </div>
