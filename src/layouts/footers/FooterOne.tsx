                  ...
                  <div className="col-lg-4">
                     <div className={`footer-intro ${style ? "position-relative z-1" : ""}`}>
                        <div className="bg-wrapper">
                           ...
                           <p className="mb-60 lg-mb-40 md-mb-20">321st route Gasabo, Kigali, Rwanda</p>
                           <h6>CONTACT</h6>
                           <Link href="#" className={`email tran3s mb-70 lg-mb-50 ${style ? "font-garamond" : "fs-24 text-decoration-underline"}`}>alainkwishima@gmail.com</Link>
